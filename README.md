...
add_gate(gate, qubits, theta=0): Append a gate to the circuit. gate is one of 'h', 'x', 'y', 'z', 'cnot', 'reset', 'measure', 'rx', 'ry', 'rz'. qubits is a list of target qubit indices; theta is required for rotation gates.
